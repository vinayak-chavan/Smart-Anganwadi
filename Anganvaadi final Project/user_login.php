...
<head>
	...
	<div class="container pad">
		<h2 align="center">User Login</h2>
			<form class="form-horizontal" action="vacancies.php"  name="form" id="form" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" placeholder="Password" id="psw" name="password" onblur="my_password()">
					<span id="password" class="text-danger"></span>
				</div>
				<div class="col-sm-6">
					<input type="submit" id="submit" name="submit" class="btn btn-primary">
					<a href="anganvaadi_index.php" type="text" id='signin' name='signin' class="btn btn-primary">SignIn
					</a>
				</div>
			</div>
			<div id="erromessage">
