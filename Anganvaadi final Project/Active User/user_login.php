...
<body>
	<div class="container">
		<h2 align="center">User Login</h2>
			<form class="form-horizontal" action="welcome.php"  name="form" id="form" method="post" enctype="multipart/form-data">
			<input type="hidden" name="erromessage">
			<div class="form-group">
				<lable class="control-lable col-sm-2" for="Email"><b>Email*:</b></lable>
				<div class="col-sm-10">
					<input type="email" class="form-control" name="email" id="mail" placeholder="Email" onblur="my_email()">
			...
			<div class="form-group">
				...
				<div class="col-sm-2">
					...
					<a href="ActiveUser.php" class="btn btn-primary">sign up</a>
				</div>
			</div>
			<div id="erromessage">
